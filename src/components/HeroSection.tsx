...
const HeroSection = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-y-auto lg:overflow-hidden">
      {/* Navigation */}
      <nav className="sticky top-0 z-20 flex items-center justify-between p-4 md:p-6 lg:p-8 bg-white lg:bg-transparent">
          ...
          <Sheet>
            ...
            <SheetContent side="right" className="bg-white/30 backdrop-blur-xl border-white/30 flex flex-col" style={{ boxShadow: 'inset 0 1px 0 0 rgba(255, 255, 255, 0.5), 0 8px 32px 0 rgba(0, 0, 0, 0.1)' }}>
              ...
              <div className="flex flex-col gap-4 mt-8 flex-1">
                ...
                <a 
                  href="#service" 
                  onClick={(e) => { e.preventDefault(); setShowServiceModal(true); }}
                  className="text-gray-900 hover:text-primary transition-colors font-semibold px-4 py-2"
                >
                  For Those Who Serve
                </a>
      ...
      <div className="relative h-full lg:h-screen flex flex-col lg:flex-row items-start lg:items-center justify-start lg:justify-between gap-8 lg:gap-0 p-4 sm:p-6 md:p-12 lg:px-16 xl:px-24 lg:py-0 pb-24 overflow-y-auto lg:overflow-hidden">
        ...
        <div className="hidden lg:block max-w-xs sm:max-w-sm md:max-w-md w-full relative lg:ml-[10%] lg:-mt-[15vh] scale-90">
          {/* Ground spot shadow */}
          <div 
        ...
        <div className="max-w-md lg:max-w-xl w-full mx-auto lg:mx-0 lg:mr-[5%] lg:-mt-[15vh] scale-90 lg:origin-right">
